...
<head>
    ...
    <!-- Animate.css -->
    <link href="{{asset('assets')}}/admin/assets/vendors/animate.css/animate.min.css" rel="stylesheet">
    <!-- Custom Theme Style -->
        ...
        <div class="animate form login_form">
            <section class="login_content">
                ...
                <form action="{{ route('admin_logincheck') }}" method="post">
                    ...
                    <div>
                        <input type="password" type="password" name="password" class="form-control" placeholder="Password" required="" />
                    </div>
                    <div>
