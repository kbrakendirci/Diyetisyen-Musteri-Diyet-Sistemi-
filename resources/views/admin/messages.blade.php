                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    @foreach($datalist as $rs)
                                        <tr>
                                            ...
                                            <td style="text-align: center"><a href="{{route('admin_message_delete', ['id' => $rs->id])}}" onclick="return confirm('Delete ! Are you sure?')"  ><img src="{{asset('assets/images')}}/delete.png" height="25" ></a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
