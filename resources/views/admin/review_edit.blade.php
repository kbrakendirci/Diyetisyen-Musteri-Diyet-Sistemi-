                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <th>Name</th><td> <a href="{{route('admin_user_show',['id'=>$data->id])}}" onclick="return !window.open(this.href, '','top=50 left=100 width=1100,height=700')">
                                                        {{$data->user->name}}</a></td>
                                            </tr><tr>
                                                <th>Home</th><td> {{ $data->treatment->title }}</td>
                                            </tr><tr>
