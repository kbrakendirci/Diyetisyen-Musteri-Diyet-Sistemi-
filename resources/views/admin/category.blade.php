                            ...
                            <div class="x_content">
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center"><a href="{{route('admin_category_delete', ['id' => $rs->id])}}" onclick="return confirm('Delete ! Are you sure?')"  > <img src="{{asset('assets/images')}}/delete.png" height="25" > </a></td>
                                    </tr>
                                    @endforeach
                                    </tbody>
                                </table>
                                <button type="button" class="btn btn-success" style=""><a style="color: #FFFFFF" href="{{route('admin_category_add')}}">Category Add</a> </button>
                            </div>
                        </div>
                    </div>
                </div>
